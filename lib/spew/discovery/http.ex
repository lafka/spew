defmodule Spew.Discovery.HTTP do
  ...
  get "/appliance/:appspec" do
    case Discovery.get Discovery.Spec.from_string appspec do
      {:ok, res} ->
        send_resp conn, 200, encode(res)
  ...
  get "/subscribe/:appspec" do
    {:ok, ref} = Discovery.subscribe Discovery.Spec.from_string appspec
    conn = send_chunked conn, 200
  ...
  get "/await/:appspec" do
    appspec = Discovery.Spec.from_string appspec
